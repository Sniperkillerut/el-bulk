...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-page p-6 relative overflow-hidden">
      {/* Dynamic Background Elements */}
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-accent-primary/10 rounded-full blur-[120px] animate-pulse"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-status-hp/5 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '2s' }}></div>

      <div className="w-full max-w-md z-10">
        <div className="card shadow-2xl relative overflow-hidden group border border-border-main/50 bg-bg-surface/60 backdrop-blur-xl p-8 sm:p-10">
          {/* Decorative Accents */}
          <div className="absolute top-0 right-0 w-32 h-32 bg-accent-primary/5 rotate-45 translate-x-16 -translate-y-16 transition-transform group-hover:scale-125"></div>
          ...
          <div className="space-y-4 relative">
            <button 
              ...
              className="w-full flex items-center justify-center gap-4 bg-white border border-[#E0E0E0] py-4 px-6 rounded-lg text-sm font-bold text-[#333] hover:bg-white hover:border-[#4285F4] hover:shadow-[0_0_20px_rgba(66,133,244,0.15)] transition-all group/btn"
              style={{ color: '#333' }}
            >
