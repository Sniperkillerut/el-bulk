        ...
        <div className="flex-1 flex flex-col p-8 min-h-0 max-w-7xl mx-auto w-full">
          <header className="flex justify-between items-start mb-8 flex-shrink-0">
            <div className="space-y-1">
              <h1 className="font-display text-5xl tracking-tighter text-ink-deep m-0 uppercase leading-none">WANTED / BOUNTIES</h1>
              <p className="font-mono-stack text-xs text-text-muted opacity-60 font-bold uppercase tracking-widest">Cards We Want to Buy // Client Requests</p>
            </div>
