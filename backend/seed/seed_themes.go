	...
	for _, t := range themes {
		_, err := db.NamedExec(`
			INSERT INTO theme (
				...
				bg_page = EXCLUDED.bg_page, bg_header = EXCLUDED.bg_header,
				bg_surface = EXCLUDED.bg_surface, bg_card = EXCLUDED.bg_card,
				text_main = EXCLUDED.text_main, text_secondary = EXCLUDED.text_secondary,
				text_muted = EXCLUDED.text_muted, text_on_accent = EXCLUDED.text_on_accent,
				text_on_header = EXCLUDED.text_on_header,
				accent_primary = EXCLUDED.accent_primary, accent_primary_hover = EXCLUDED.accent_primary_hover,
				border_main = EXCLUDED.border_main, border_focus = EXCLUDED.border_focus,
				status_nm = EXCLUDED.status_nm, status_lp = EXCLUDED.status_lp,
				status_mp = EXCLUDED.status_mp, status_hp = EXCLUDED.status_hp,
				status_dmg = EXCLUDED.status_dmg,
				btn_primary_bg = EXCLUDED.btn_primary_bg, btn_primary_text = EXCLUDED.btn_primary_text,
				btn_secondary_bg = EXCLUDED.btn_secondary_bg, btn_secondary_text = EXCLUDED.btn_secondary_text,
				checkbox_border = EXCLUDED.checkbox_border, checkbox_checked = EXCLUDED.checkbox_checked,
				radius_base = EXCLUDED.radius_base, padding_card = EXCLUDED.padding_card,
				gap_grid = EXCLUDED.gap_grid, bg_image_url = EXCLUDED.bg_image_url,
				font_heading = EXCLUDED.font_heading, font_body = EXCLUDED.font_body,
				accent_secondary = EXCLUDED.accent_secondary,
				accent_header = EXCLUDED.accent_header, status_hp_header = EXCLUDED.status_hp_header
		`, t)
		if err != nil {
