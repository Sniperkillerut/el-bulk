...
func seedStoreExclusives(db *sqlx.DB, cats CategoryMap, storage StorageMap) ([]string, error) {
	...
	seedDeckCards := func(deckID string, identifiers []external.CardIdentifier) {
		...
		for _, identifier := range identifiers {
			res, err := external.LookupMTGCard(
				context.Background(),
				identifier.ScryfallID, identifier.Name, identifier.SetCode,
				identifier.CollectorNumber, "non_foil",
			)
			if err != nil {
				logger.Error("  ❌ Card NOT found: %s (%s #%s): %v",
					identifier.Name, identifier.SetCode, identifier.CollectorNumber, err)
				continue
			}
			r := *res
			qty := 1
	...
	seedDeckCards(goblinID, []external.CardIdentifier{
		{Name: "Krenko, Mob Boss", SetCode: "rvr", CollectorNumber: "114"},
		{Name: "Goblin Chieftain", SetCode: "jmp", CollectorNumber: "324"},
		{Name: "Goblin Warchief", SetCode: "dom", CollectorNumber: "130"},
		{Name: "Goblin Guide", SetCode: "zen", CollectorNumber: "136"},
		{Name: "Siege-Gang Commander", SetCode: "dom", CollectorNumber: "144"},
		{Name: "Skirk Prospector", SetCode: "ons", CollectorNumber: "222"},
		{Name: "Goblin Matron", SetCode: "7ed", CollectorNumber: "190"},
		{Name: "Goblin Recruiter", SetCode: "vis", CollectorNumber: "93"},
		{Name: "Reckless Bushwhacker", SetCode: "ogw", CollectorNumber: "115"},
		{Name: "Lightning Bolt", SetCode: "m11", CollectorNumber: "149"},
		{Name: "Pyroclasm", SetCode: "m11", CollectorNumber: "155"},
		{Name: "Goblin Bombardment", SetCode: "tsx", CollectorNumber: "99"},
		{Name: "Phyrexian Altar", SetCode: "inv", CollectorNumber: "308"},
		{Name: "Sol Ring", SetCode: "clb", CollectorNumber: "882"},
		{Name: "Arcane Signet", SetCode: "clb", CollectorNumber: "861"},
		{Name: "Swiftfoot Boots", SetCode: "cmr", CollectorNumber: "474"},
		{Name: "Lightning Greaves", SetCode: "cmr", CollectorNumber: "470"},
		{Name: "Mountain", SetCode: "usg", CollectorNumber: "343"},
		{Name: "Mountain", SetCode: "usg", CollectorNumber: "344"},
		{Name: "Mountain", SetCode: "usg", CollectorNumber: "345"},
		{Name: "Ancient Tomb", SetCode: "tmp", CollectorNumber: "315"},
		{Name: "Cavern of Souls", SetCode: "avr", CollectorNumber: "226"},
	})
	...
	seedDeckCards(dragonID, []external.CardIdentifier{
		// Commander
		{Name: "The Ur-Dragon", SetCode: "c17", CollectorNumber: "48"},
		// Dragons
		{Name: "Miirym, Sentinel Wyrm", SetCode: "clb", CollectorNumber: "284"},
		{Name: "Lathliss, Dragon Queen", SetCode: "m19", CollectorNumber: "149"},
		{Name: "Terror of the Peaks", SetCode: "m21", CollectorNumber: "164"},
		{Name: "Balefire Dragon", SetCode: "isd", CollectorNumber: "129"},
		{Name: "Dragonlord Dromoka", SetCode: "dtk", CollectorNumber: "217"},
		{Name: "Dragonlord Silumgar", SetCode: "dtk", CollectorNumber: "220"},
		{Name: "Dragonlord Kolaghan", SetCode: "dtk", CollectorNumber: "218"},
		{Name: "Dragonlord Atarka", SetCode: "dtk", CollectorNumber: "216"},
		{Name: "Dragonlord Ojutai", SetCode: "dtk", CollectorNumber: "219"},
		{Name: "Tiamat", SetCode: "afr", CollectorNumber: "235"},
		// Support
		{Name: "Sol Ring", SetCode: "clb", CollectorNumber: "882"},
		{Name: "Arcane Signet", SetCode: "clb", CollectorNumber: "861"},
		{Name: "Dragon's Hoard", SetCode: "m19", CollectorNumber: "232"},
		{Name: "Chromatic Lantern", SetCode: "grn", CollectorNumber: "233"},
		{Name: "The Great Henge", SetCode: "eld", CollectorNumber: "161"},
		{Name: "Rhystic Study", SetCode: "pcy", CollectorNumber: "45"},
		{Name: "Smothering Tithe", SetCode: "rna", CollectorNumber: "22"},
		{Name: "Cyclonic Rift", SetCode: "rtr", CollectorNumber: "35"},
		{Name: "Swords to Plowshares", SetCode: "clb", CollectorNumber: "707"},
		// Lands
		{Name: "Command Tower", SetCode: "cm2", CollectorNumber: "242"},
		{Name: "Path of Ancestry", SetCode: "c17", CollectorNumber: "63"},
		{Name: "Stomping Ground", SetCode: "rna", CollectorNumber: "259"},
		{Name: "Steam Vents", SetCode: "grn", CollectorNumber: "257"},
		{Name: "Breeding Pool", SetCode: "rna", CollectorNumber: "246"},
		{Name: "Blood Crypt", SetCode: "rna", CollectorNumber: "245"},
		{Name: "Wooded Foothills", SetCode: "ons", CollectorNumber: "330"},
		{Name: "Polluted Delta", SetCode: "ons", CollectorNumber: "335"},
		{Name: "Scalding Tarn", SetCode: "zen", CollectorNumber: "223"},
		{Name: "Ancient Tomb", SetCode: "tmp", CollectorNumber: "315"},
	})
	...
	seedDeckCards(elfID, []external.CardIdentifier{
		{Name: "Selvala, Heart of the Wilds", SetCode: "cns", CollectorNumber: "181"},
		{Name: "Llanowar Elves", SetCode: "dom", CollectorNumber: "168"},
		{Name: "Fyndhorn Elves", SetCode: "ice", CollectorNumber: "259"},
		{Name: "Priest of Titania", SetCode: "usg", CollectorNumber: "263"},
		{Name: "Elvish Archdruid", SetCode: "m10", CollectorNumber: "168"},
		{Name: "Wirewood Symbiote", SetCode: "lgn", CollectorNumber: "141"},
		{Name: "Glimpse of Nature", SetCode: "chk", CollectorNumber: "212"},
		{Name: "Green Sun's Zenith", SetCode: "mbs", CollectorNumber: "117"},
		{Name: "Craterhoof Behemoth", SetCode: "avr", CollectorNumber: "175"},
		{Name: "Ezuri, Renegade Leader", SetCode: "som", CollectorNumber: "118"},
		{Name: "Heritage Druid", SetCode: "mor", CollectorNumber: "120"},
		{Name: "Nettle Sentinel", SetCode: "mor", CollectorNumber: "131"},
		{Name: "Chord of Calling", SetCode: "m15", CollectorNumber: "173"},
		{Name: "Sylvan Library", SetCode: "ema", CollectorNumber: "187"},
		{Name: "Gaea's Cradle", SetCode: "usg", CollectorNumber: "321"},
		{Name: "Nykthos, Shrine to Nyx", SetCode: "ths", CollectorNumber: "223"},
		{Name: "Sol Ring", SetCode: "clb", CollectorNumber: "882"},
		{Name: "Forest", SetCode: "clb", CollectorNumber: "457"},
		{Name: "Forest", SetCode: "clb", CollectorNumber: "458"},
	})
