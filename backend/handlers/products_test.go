...
func TestProductHandler_List(t *testing.T) {
	...
	t.Run("Basic List", func(t *testing.T) {
		...
		mock.ExpectQuery("(?i)SELECT p\\.id.* FROM products p").WillReturnRows(rows)
		
		mock.ExpectQuery("(?i)SELECT key, value FROM settings").WillReturnRows(sqlmock.NewRows([]string{"key", "value"}).AddRow("usd_to_cop", "4000"))
		mock.ExpectQuery("(?i)SELECT ps\\.product_id, s\\.id as stored_in_id.*").WillReturnRows(sqlmock.NewRows([]string{"product_id", "stored_in_id", "name", "quantity"}).AddRow("p1", "loc1", "Box 1", 10))
		mock.ExpectQuery("(?i)SELECT pc\\.product_id, c\\.id, c\\.name.*").WillReturnRows(sqlmock.NewRows([]string{"product_id", "id", "name", "slug", "show_badge", "is_active", "searchable"}).AddRow("p1", "cat1", "Cat 1", "cat1", true, true, true))
...
func TestProductHandler_GetByID(t *testing.T) {
	...
	t.Run("Found", func(t *testing.T) {
		...
		mock.ExpectQuery("(?i)SELECT p\\..* FROM products p").
			WithArgs("p1").
			WillReturnRows(row)
...
func TestProductHandler_Create(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mock.ExpectExec("DELETE FROM product_categories WHERE product_id = \\$1").WithArgs("p-new").WillReturnResult(sqlmock.NewResult(0, 0))
		mock.ExpectExec("DELETE FROM product_stored_in WHERE product_id = \\$1").WithArgs("p-new").WillReturnResult(sqlmock.NewResult(0, 0))
...
func TestProductHandler_Update(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mock.ExpectQuery("(?i)UPDATE products").
			WillReturnRows(sqlmock.NewRows([]string{"id", "name", "tcg", "category"}).AddRow("p1", "Updated Name", "mtg", "singles"))

		mock.ExpectExec("DELETE FROM product_categories WHERE product_id = \\$1").WithArgs("p1").WillReturnResult(sqlmock.NewResult(0, 0))
		mock.ExpectExec("DELETE FROM product_stored_in WHERE product_id = \\$1").WithArgs("p1").WillReturnResult(sqlmock.NewResult(0, 0))
...
func TestProductHandler_BulkCreate(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mock.ExpectBegin()
		mock.ExpectQuery("INSERT INTO products").WithArgs(sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg(), sqlmock.AnyArg()).
...
func TestProductHandler_GetStorage(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mock.ExpectQuery("(?i)SELECT s\\.id as stored_in_id.*FROM stored_in s").
			WithArgs("p1").
			WillReturnRows(rows)
...
func TestProductHandler_UpdateStorage(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mock.ExpectBegin()
		mock.ExpectExec("DELETE FROM product_stored_in WHERE product_id = \\$1").WithArgs("p1").WillReturnResult(sqlmock.NewResult(0, 1))
		mock.ExpectExec("INSERT INTO product_stored_in").WithArgs("p1", "loc1", 5).WillReturnResult(sqlmock.NewResult(0, 1))
		mock.ExpectCommit()

		// GetStorage follow-up
		mock.ExpectQuery("(?i)SELECT s\\.id as stored_in_id.*FROM stored_in s").WithArgs("p1").WillReturnRows(sqlmock.NewRows([]string{"stored_in_id", "name", "quantity"}).AddRow("loc1", "Box 1", 5))
